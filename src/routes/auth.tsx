...
function Auth() {
  ...
  const incrementAttempts = () => {
    ...
    if (data.count >= 5) {
      ...
      toast.error(
        `Invalid login credentials. You have ${attemptsLeft} attempt${attemptsLeft === 1 ? "" : "s"} left.`,
      );
    }
  ...
  const checkLockStatus = (): boolean => {
    ...
    if (data.lockedUntil && Date.now() < data.lockedUntil) {
      const hoursRemaining = Math.ceil(
        (data.lockedUntil - Date.now()) / 3600000,
      );
      toast.error(
        `Login is temporarily locked. Try again in ${hoursRemaining} hours.`,
      );
      return true;
    }
    if (data.lockedUntil && Date.now() >= data.lockedUntil) {
  ...
  // Handle detection of Recovery mode on mount or URL changes
  useEffect(() => {
    const checkHash = () => {
  ...
  async function handleResetPassword(e: React.FormEvent) {
    ...
    try {
      ...
      // Clean up URL hash / query to prevent triggering recoveryMode again on refresh/back
    ...
    return (
      <div className="min-h-screen bg-[#070707] text-[#f4f4f2] flex items-center justify-center p-4">
        <div className="w-full max-w-md text-center bg-[#111]/90 backdrop-blur-xl border border-white/10 p-8 rounded-2xl shadow-2xl">
          ...
          <h1 className="text-2xl font-heading mb-2 font-bold text-white uppercase tracking-tight">
            Verify your email
          </h1>
          ...
          <p className="text-sm text-[#8d8d8d] mb-6">
            Open your email inbox, click the verification link, then return
            here.
          </p>
          <button
            ...
            style={{
              background:
                "linear-gradient(to right, rgb(111, 0, 0), rgb(186, 0, 0))",
            }}
          >
            Go to Login
          </button>
      ...
      <div className="hidden lg:flex relative h-full w-full overflow-hidden bg-black select-none z-0">
        ...
        <div className="absolute bottom-14 left-12 z-20 max-w-md space-y-3 text-left">
          ...
          <p className="text-[#8d8d8d] text-sm leading-relaxed max-w-sm">
            Deploy the ultimate athletic management console. Monitor live logs,
            process supplementary transactions, and automate membership
            workflows.
          </p>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center p-4 sm:p-6 lg:h-full z-10 bg-[#070707] relative overflow-hidden">
        ...
        <div className="w-full max-w-[380px] relative z-10">
          ...
          >
            ...
            <div className="flex justify-center mb-4">
              <img
                src={logoPng}
                alt="Alpha Fitness"
                className="h-20 object-contain drop-shadow-[0_5px_8px_rgba(0,0,0,0.45)]"
              />
            </div>
            ...
            <div className="text-center mb-4">
              <h1 className="text-xl sm:text-2xl font-heading font-bold text-white uppercase tracking-tight">
                {recoveryMode ? (
                  <>
                    RESET <span className="text-[#ed3434]">PASSWORD</span>
                  </>
                ) : mode === "login" ? (
                  <>
            ...
            {recoveryMode ? (
              <form onSubmit={handleResetPassword} className="space-y-3.5">
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-2.5 top-1/2 -translate-y-1/2 text-[#666] hover:text-white cursor-pointer bg-transparent border-0 font-normal"
                  >
                    {showNewPass ? (
              ...
              <>
                      ...
                      <form onSubmit={handleVerifyOtp} className="space-y-3">
                        <div className="relative">
                          ...
                          <input
                            ...
                            className={
                              inp + " text-center tracking-[0.3em] font-bold"
                            }
                            required
                          />
                        </div>
                        <p className="text-[11px] text-[#8d8d8d] text-center -mt-1">
                          Code sent to{" "}
                          <span className="text-[#ed3434]">{form.email}</span>
                        </p>
                ...
                <div className="relative flex items-center justify-center my-3.5">
                  ...
                  <span
                    className="relative px-3 text-[10px] uppercase tracking-widest text-[#666] font-bold"
                  ...
                  {mode === "login" ? (
                    <p>
                      ...
                      <button
                        ...
                        className="text-[#ed3434] hover:underline font-bold"
                      >
                        Sign Up
                      </button>
                    </p>
          ...
          <div className="flex justify-center gap-6 mt-5">
            {[
              ...
              >
                ...
                <span className="text-[8px] uppercase font-bold tracking-wider text-[#8d8d8d]">
                  {item.label}
                </span>
              </div>
            ))}
          ...
          <div className="text-center mt-3">
            <Link
              to="/"
              className="text-[11px] text-[#666] hover:text-white font-medium transition inline-flex items-center gap-1.5 uppercase tracking-wider"
            >
