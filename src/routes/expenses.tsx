    ...
    <div className="p-4 sm:p-8 max-w-[1400px] w-full">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4 mb-6">
        {byCat.map(({ c, total }) => (
          <div
            key={c}
            className="bg-card border border-border rounded-xl p-3 sm:p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-1"
          >
      ...
      <form
        onSubmit={add}
        className="bg-card border border-border rounded-2xl p-4 grid grid-cols-1 sm:grid-cols-[1fr,140px,140px,auto] gap-3 mb-6"
      >
        <input
        ...
        <button
          type="submit"
          className="px-5 py-2.5 bg-brand text-brand-foreground rounded-lg font-semibold text-sm hover:scale-[1.01] transition-transform cursor-pointer text-center"
        >
          Add Expense
        </button>
      </form>
              ...
              {expenses.map((e) => (
                <tr key={e.id} className="hover:bg-secondary/30">
                  ...
                  <td className="px-4 py-3">
                    <span className="px-2 py-0.5 bg-secondary text-xs rounded font-medium">
                      {e.category}
                    </span>
                  </td>
