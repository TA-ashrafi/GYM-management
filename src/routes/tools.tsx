...
function Tools() {
  ...
  return (
    <div className="p-8 max-w-[1600px]">
      <PageHeader
        title="Fitness Tools"
        subtitle="BMI · TDEE · Macros · Diet Plan Generator"
      />
          ...
          {activeTab === "calorie" && (
            <div className="bg-card border border-border rounded-2xl p-6 space-y-6">
              ...
              <div>
                ...
                <p className="text-5xl font-heading mt-1 text-brand">
                  {Math.round(tdee)}
                </p>
              </div>
              <div>
                ...
                <p className="text-5xl font-heading mt-1">
            ...
            <div className="bg-card border border-border rounded-2xl p-6 space-y-6">
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  Based on {form.weight}kg body weight × 2.0g/kg
                </p>
              </div>
              <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-4 mt-2">
                  ...
                  <div className="p-4 bg-secondary/40 rounded-lg text-center">
                    ...
                    <p className="text-2xl font-heading text-warn">
                      {Math.round(carbs)}g
                    </p>
                  </div>
                  <div className="p-4 bg-secondary/40 rounded-lg text-center">
                    <p className="text-xs text-muted-foreground">Fat</p>
                    <p className="text-2xl font-heading text-danger">
                      {Math.round(fat)}g
                    </p>
                  </div>
                </div>
              ...
              <div className="p-4 bg-brand/10 border border-brand/20 rounded-lg">
                ...
                <div className="flex h-4 rounded-full overflow-hidden mt-2">
                  <div
                    ...
                    style={{ width: `${((protein * 4) / targetCals) * 100}%` }}
                  />
                  <div
                    className="h-full bg-warn"
                    style={{ width: `${((carbs * 4) / targetCals) * 100}%` }}
                  />
                  <div
                    className="h-full bg-danger"
                    style={{ width: `${((fat * 9) / targetCals) * 100}%` }}
                  />
                </div>
                <div className="flex justify-between text-xs text-muted-foreground mt-1">
                  <span>
                    Protein {Math.round(((protein * 4) / targetCals) * 100)}%
                  </span>
                  <span>
                    Carbs {Math.round(((carbs * 4) / targetCals) * 100)}%
                  </span>
